...
class _AddMobile extends StatefulWidget {
  final AddViewModel viewModel;
  _AddMobile(this.viewModel, {Key key}) : super(key: key);

  @override
  __AddMobileState createState() => __AddMobileState();
}

class __AddMobileState extends State<_AddMobile> {
  AddViewModel _vm;
