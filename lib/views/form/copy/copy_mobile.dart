...
class _CopyMobile extends StatefulWidget {
  final CopyViewModel viewModel;
  _CopyMobile(this.viewModel, {Key key}) : super(key: key);

  @override
  __CopyMobileState createState() => __CopyMobileState();
}

class __CopyMobileState extends State<_CopyMobile> {
  CopyViewModel _vm;
